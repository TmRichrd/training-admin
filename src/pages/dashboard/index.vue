<template>
  <div class="p-6">
    <div class="mb-8">
    <h1 class="text-2xl font-medium mb-2">欢迎回来，用户名</h1>
  ...
  <div class="mb-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div class="rounded-lg border bg-white text-card-foreground shadow-sm overflow-hidden" v-for="item in popularCourses"
        :key="item.id">
